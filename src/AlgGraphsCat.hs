...
-- of 'a' that were preserved by the homomorpism. We have no reasonable way of getting the action of the morpisms 
-- elements in the universe that are not in edges without enumerating the type so its not really feasable to get
-- the true equiliser
